...
namespace DotNetAES.Extensions
{
    ...
    public static partial class AESDataTableExtensions
    {
        ...
        /// <returns></returns>
        public static DataTable AESDecrypt(this DataTable data, AES encryptionEngine, string ivColumnName, object key)
        {
                ...
                foreach (DataRow dr in data.Rows)
                {
                    ...
                    foreach (DataColumn col in data.Columns)
                    {
                           ...
                           )
                        {
                            ...
                            newRow[col.ColumnName] = encryptionEngine.DecryptToType<string>(dr[col], key, dr[ivColumnName]);
                        }
                        else
                        {
        ...
        /// <returns></returns>
        public static DataTable AESDecryptIgnore(this DataTable data, AES encryptionEngine, string ivColumnName, object key, params string[] ignoreColumns)
        {
            //Checks the table even has values before continuing
            if (
                //Checks we have some form of data being supplied
        ...
        /// <returns></returns>
        public static DataTable AESDecryptOnly(this DataTable data, AES encryptionEngine, string ivColumnName, object key, params string[] onlyColumns)
        {
            //Checks the table even has values before continuing
            if (
                //Checks we have some form of data being supplied
