...
{    
    public static partial class AESHMAC512DataTableExtensions
    {
        ...
        /// <returns></returns>
        public static DataTable AESHMAC512Decrypt(this DataTable data, object cryptKey, object authKey)
        {
        ...
        /// <returns></returns>
        public static DataTable AESHMAC512DecryptIgnore(this DataTable data, object cryptKey, object authKey, params string[] ignoreColumns)
        {
            //Checks the table even has values before continuing
            if (
                //Checks we have some form of data being supplied
        ...
        /// <returns></returns>
        public static DataTable AESHMAC512DecryptOnly(this DataTable data, object cryptKey, object authKey, params string[] onlyColumns)
        {
            //Checks the table even has values before continuing
            if (
                //Checks we have some form of data being supplied
